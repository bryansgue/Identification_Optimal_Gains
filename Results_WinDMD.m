...
% 
% %% Legend nomeclature
% hLegend_1 = legend([ul_vali,ul_ref_vali, ulm_vali],{'$\mu_{l}$','$\mu_{lref}$','$\mu_{lm}$'},'fontsize',11,'interpreter','latex','Color',[255 255 255]/255,'NumColumns',1,'TextColor','black');
%  set(gca,'ticklabelinterpreter','latex',...
%          'fontsize',1.1*fontsizeTicks)
% %% Figure properties
% ax_1 = gca;
...
% 
% %% Legend nomeclature
% hLegend_2 = legend([um_vali,um_ref_vali, umm_vali],{'$\mu_{m}$','$\mu_{mref}$','$\mu_{mm}$'},'fontsize',11,'interpreter','latex','Color',[255 255 255]/255,'NumColumns',1,'TextColor','black');
%  set(gca,'ticklabelinterpreter','latex',...
%          'fontsize',1*fontsizeTicks)
% %% Figure properties
% ax_2 = gca;
...
% 
% %% Legend nomeclature
% hLegend_3 = legend([un_vali,un_ref_vali, unm_vali],{'$\mu_{n}$','$\mu_{nref}$','$\mu_{nm}$'},'fontsize',11,'interpreter','latex','Color',[255 255 255]/255,'NumColumns',1,'TextColor','black');
%  set(gca,'ticklabelinterpreter','latex',...
%          'fontsize',1*fontsizeTicks)
% %% Figure properties
% ax_3 = gca;
...
% 
% %% Legend nomeclature
% hLegend_4 = legend([w_vali,w_ref_vali, w_m_vali],{'$\omega$','$\omega_{ref}$','$\omega_{m}$'},'fontsize',11,'interpreter','latex','Color',[255 255 255]/255,'NumColumns',1,'TextColor','black');
%  set(gca,'ticklabelinterpreter','latex',...
%          'fontsize',1*fontsizeTicks)
% %% Figure properties
% ax_4 = gca;
...
export_fig IdentWinDMD.pdf -q101