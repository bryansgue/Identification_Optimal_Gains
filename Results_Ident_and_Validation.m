...
%% Legend nomeclature
hLegend_1 = legend([ul_iden,ul_ref_iden, ulm_iden],{'$\mu_{l}$','$\mu_{lref}$','$\mu_{lm}$'},'fontsize',11,'interpreter','latex','Color',[255 255 255]/255,'NumColumns',1,'TextColor','black');
...
%% Legend nomeclature
hLegend_2 = legend([um_iden,um_ref_iden, umm_iden],{'$\mu_{m}$','$\mu_{mref}$','$\mu_{mm}$'},'fontsize',11,'interpreter','latex','Color',[255 255 255]/255,'NumColumns',1,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
...
%% Legend nomeclature
hLegend_3 = legend([un_iden,un_ref_iden, unm_iden],{'$\mu_{n}$','$\mu_{nref}$','$\mu_{nm}$'},'fontsize',11,'interpreter','latex','Color',[255 255 255]/255,'NumColumns',1,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',1*fontsizeTicks)
%% Figure properties
ax_3 = gca;
...
%% Legend nomeclature
hLegend_4 = legend([w_iden,w_ref_iden, w_m_iden],{'$\omega$','$\omega_{ref}$','$\omega_{m}$'},'fontsize',11,'interpreter','latex','Color',[255 255 255]/255,'NumColumns',1,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',1*fontsizeTicks)
%% Figure properties
ax_4 = gca;
...
%% Legend nomeclature
hLegend_1 = legend([ul_iden,ul_ref_iden, ulm_iden, ulwin_iden],{'$\mu_{l}$','$\mu_{lref}$','$\mu_{lm}$','$\mu_{lwindowed}$'},'fontsize',11,'interpreter','latex','Color',[255 255 255]/255,'NumColumns',1,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',1.1*fontsizeTicks)
%% Figure properties
ax_1 = gca;
...
%% Legend nomeclature
hLegend_2 = legend([um_iden,um_ref_iden, umm_iden, umwin_iden],{'$\mu_{m}$','$\mu_{mref}$','$\mu_{mm}$','$\mu_{mwindowed}$'},'fontsize',11,'interpreter','latex','Color',[255 255 255]/255,'NumColumns',1,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',1*fontsizeTicks)
%% Figure properties
ax_2 = gca;
...
%% Legend nomeclature
hLegend_3 = legend([un_iden,un_ref_iden, unm_iden, unwin_iden],{'$\mu_{n}$','$\mu_{nref}$','$\mu_{nm}$','$\mu_{nwindowed}$'},'fontsize',11,'interpreter','latex','Color',[255 255 255]/255,'NumColumns',1,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',1*fontsizeTicks)
%% Figure properties
ax_3 = gca;
...
%% Legend nomeclature
hLegend_4 = legend([w_iden,w_ref_iden, w_m_iden, wwin_iden],{'$\omega$','$\omega_{ref}$','$\omega_{m}$','$\omega_{windowed}$'},'fontsize',11,'interpreter','latex','Color',[255 255 255]/255,'NumColumns',1,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',1*fontsizeTicks)
%% Figure properties
ax_4 = gca;
...
export_fig Validation_identification.pdf -q101